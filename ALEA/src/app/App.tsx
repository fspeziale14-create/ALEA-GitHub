...
.dark div.rounded-xl.border, .dark div.rounded-2xl.border, .dark button.rounded-2xl.border, .dark button.rounded-2xl.border-2 {
  box-shadow: 0 8px 32px rgba(0,0,0,0.5) !important;
}
div.rounded-xl.border, div.rounded-2xl.border, button.rounded-2xl.border, button.rounded-2xl.border-2 {
...
@keyframes alea-card-expand {
  from { opacity: 0.7; transform: scale(0.96); }
  to   { opacity: 1;   transform: scale(1); }
}
.alea-card-expand {
  animation: alea-card-expand 0.28s cubic-bezier(0.22, 1, 0.36, 1) forwards;
      ...
      <SidebarProvider defaultOpen={true} className="h-full">
        ...
        <SidebarInset className={`w-full h-full overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:hidden [scrollbar-width:none] ${bgColor} transition-colors duration-500`}>
          ...
          {menuSubView === 'inventario' && (
            <>
              <div className="alea-card-expand flex-1 flex flex-col min-h-0">
